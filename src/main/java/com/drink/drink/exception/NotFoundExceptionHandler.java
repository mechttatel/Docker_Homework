...
public class NotFoundExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({NotFoundException.class, ListIsEmptyException.class})
    protected ResponseEntity<Object> handleNotFoundException(NotFoundException notFoundException) {
        ApiError apiError = new ApiError("Exception", notFoundException.getMessage());
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }

    protected ResponseEntity<Object> handleListIsEmptyException(ListIsEmptyException listIsEmptyException) {
        ApiError apiError = new ApiError("Exception", listIsEmptyException.getMessage());
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }
